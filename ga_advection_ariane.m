...
%
% Optional inputs:
% 'dt' 				output resolution in days (default 0.2 days). NOTE: for Ariane dt impacts the output resolution only, NOT the result (small dt slightly increases processing time).
...
%
% Output:
% positions			structure containing .lon2D (nb traj x nb time advec), .lat2D, .time, .lon_ini, .lat_ini
%
