...
%% GA_WRITE_ARIANE_NAMELIST: writes the namelist file used by Ariane (automatically generated within ga_advection_ariane)
%
% ga_write_ariane_namelist(name_curr,varargin)
%
% Varargin inputs:
% 'dt' 				time step for calculation, in days (required)
