...
grid_u.lon=grid_u.lon(1:end-1); grid_u.lat=grid_u.lat(1:end-1);
grid_v.lon=grid_v.lon(1:end-1); grid_v.lat=grid_v.lat(1:end-1); 
grid_r.lon=curr.lon(1:end-1); grid_r.lat=curr.lat(1:end-1);
